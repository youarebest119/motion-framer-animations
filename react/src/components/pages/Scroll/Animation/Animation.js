...
const Animation = () => {
    ...
    const scale = useTransform(scrollYProgress, [0, 0.15, 0.4, 0.8, 1], [0.8, 0.8, 1, 1, 0.8])
    const scaleBox = useTransform(scrollYProgress, [0.4, 0.6], [1, 0])
    const y = useTransform(scrollYProgress, [0.4, 0.6], [1000, 0])
    const scaleVideo = useTransform(scrollYProgress, [0.4, 0.6], [0.6, 1])
